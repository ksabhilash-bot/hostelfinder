  ...
  return (
    <div className="flex items-center gap-2">
      <motion.div
        ...
        className="h-4 w-4 rounded-full border border-neutral-300 bg-gradient-to-b from-rose-400 to-rose-300"
      />
      <motion.div
        initial={{
          y: 0,
        ...
        className="h-5 w-5 rounded-full border border-neutral-300 bg-gradient-to-b from-rose-500 to-rose-400"
      />
      <motion.div
        initial={{
          y: 0,
        ...
        className="h-6 w-6 rounded-full border border-neutral-300 bg-gradient-to-b from-rose-600 to-rose-500"
      />
    </div>
  );
};
